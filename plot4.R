...
yToplot4 <- as.numeric(dataToPlot$Voltage)
yToplot5 <- as.numeric(dataToPlot$Global_reactive_power)

#open png
png("D:/Study/datascientist/Cours4/ExData_Plotting1/plot4.png", width = 480, height = 480)
par(mfrow = c(2,2))

#plot a graph
plot(xToPlot, yToplot, type = "l", xlab = "", ylab = "Global Active Power(kilowatts)" )
plot(xToPlot, yToplot4, type = "l", xlab = "datetime", ylab = "Voltage")
...
plot(xToPlot, yToplot5, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
